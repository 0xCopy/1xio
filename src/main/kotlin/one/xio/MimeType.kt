 ...
 * Time: 2:42:05 AM
 */
enum class MimeType private constructor(vararg var contentTypes: String) {
    `323`("text/h323"),
    `3gp`("video/3gpp"),
    ...
    m3g("application/m3g"),
    m3u8("application/x-mpegURL", "audio/x-mpegurl"),
    m4a("audio/mpeg"),
    ...
    vcard("text/vcard"),
    vcd("application/x-cdlink", "text/vcard", "text/x-vcalendar"),
    vmd("chemical/x-vmd"),
    ...
    open override fun toString() = decode(name, UTF_8.name())
    val contentType  get() = contentTypes[0]
}
